...
import pandas as pd
import os
from training.inference import model_fn, predict_fn
...
# Sagemaker
MODEL_PATH = os.getenv("MODEL_PATH", "mlruns/1/models/m-8796c0c4a06b4f29bf133a30a8354251/artifacts")
...
def predict(features: dict) -> str:
    ...
    result = predict_fn(features,model)
